...
### Kết quả tốt nhất hiện tại (Trên Public Leaderboard: 0.6458 - Rank 49)
...
| **Auto-ML (tsfresh)** | Fourier Transform, Entropy, Autocorrelation | **0.42** | Có thể có nhiễu, ít ý nghĩa vật lý. |
